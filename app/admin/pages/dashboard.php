...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="alert alert-secondary" style="color: #383d41; background-color: #e2e3e5; border-color: #d6d8db;">
            Selamat Datang, <?= $_SESSION['fullname']; ?> di Administrator Perpustakaan SMP N 17 AMBON.
        </div>
        ...
        <div class="row">
            ...
            <h2 class="text-center" style="font-family: Quicksand, sans-serif;">Perpustakaan SMP N 17 AMBON</h2>
            <p class="text-center">Alamat : Jl. DR. Kayadoe, Kel Benteng, Kec. Nusaniwe, Kota Ambon, Maluku</p>
